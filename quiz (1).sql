...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 21. Jun 2021 um 12:45
...
(1, 'Was ist das flächenmäßig kleinste Bundesland Deutschlands?', 'JonasCentarti', 1, 0),
(2, 'Wie lautet die Hauptstadt von Frankreich?', 'JonasCentarti', 1, 0),
(3, 'Wie viele Bundesländer hat Deutschland?', 'JonasCentarti', 1, 0),
(4, 'Wie heißt die Hauptstadt von Thüringen?', 'JonasCentarti', 1, 0),
(5, 'Wer gewann die Fußball Weltmeisterschaft 2002?', 'JonasCentarti', 2, 0),
(6, 'In welcher dieser Sportarten werden Schläger verwendet?', 'JonasCentarti', 2, 0);
